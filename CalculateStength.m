...
clear
data_path = strcat('/Volumes/','Ext. Drive','/seiche2D/2048x1024/Amp05/h005/');
save_path = strcat('/Volumes/','Ext. Drive','/seiche2D/Notes/');
cd(data_path)
...
t = linspace(0,final_time,length(0:10:numouts));
